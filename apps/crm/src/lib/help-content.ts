      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ['Parolimni unutdim', "Kirish sahifasida «Parolni unutdingizmi?» ni bosing — Telegram botga tiklash kodi keladi, shu kod bilan yangi parol o'rnatasiz. Telegram ulanmagan bo'lsa avval botga /start yuborib raqamingizni ulang."],
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ['Забыл пароль', 'На странице входа нажмите «Забыли пароль?» — в Telegram-бот придёт код восстановления, с ним вы зададите новый пароль. Если Telegram не привязан, сначала отправьте боту /start и поделитесь номером.'],
